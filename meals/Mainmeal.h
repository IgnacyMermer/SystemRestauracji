...
public:
    ...
    Mainmeal(string id, string shortname, string name, bool availability, int productsCount, vector<string> ingredients,double price,string type):Meal(id, shortname, name, availability, productsCount, ingredients, price){}
